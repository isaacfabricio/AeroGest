pipeline {
    ...
    environment {
        ...
        EMAIL_RECIPIENT = 'seu-email@exemplo.com'
    }
    ...
    post {
        success {
            mail to: "${env.EMAIL_RECIPIENT}",
                 ...
                 body: "O deploy do projeto foi concluído com sucesso."
        }
        failure {
            mail to: "${env.EMAIL_RECIPIENT}",
                 subject: "Falha no deploy",
                 body: "O deploy do projeto falhou. Verifique os logs para mais detalhes."
        }
    }
}
